...
public class VideosFragment extends Fragment {
    ...
    String baseURL = "https://www.marineinsight.com/api/get_recent_posts/?json=get_category_posts&slug=videos&count=10";
    String json;
    ...
    class JSONAsync extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            PostAdapterVideos postAdapterVideos = new PostAdapterVideos(getActivity(), postList);
            rv.setAdapter(postAdapterVideos);
            pd.dismiss();
        }
    }
}
