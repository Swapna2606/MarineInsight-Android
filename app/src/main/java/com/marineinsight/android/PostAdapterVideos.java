 ...
 */
public class PostAdapterVideos extends RecyclerView.Adapter<PostAdapterVideos.ViewHolder> {
    ...
    public PostAdapterVideos(Context context, List<PostValue> postList) {
...
//    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View normalView = inflater.inflate(R.layout.list_item_post_first, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Picasso.with(context).load(currentPost.getThumbnailUrl()).into(holder.img_android);
    }
